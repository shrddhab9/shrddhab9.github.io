...
function theme_customize_register($wp_customize) {
    ...
    $wp_customize->add_control('color_scheme', array(
        'label' => __('Color Scheme', 'website723662'),
        'section' => 'colors',
        'type' => 'select',
        'choices' => array(),
        'priority' => 1,
    ...
    for ($i = 1; $i <= 5; $i++) {
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_$i", array(
            'label' => sprintf(__('Color %s', 'website723662'), $i),
            'section' => 'colors',
        )));
    }
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_white_contrast", array(
        'label' => __('Text Dark', 'website723662'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_shading_contrast", array(
        'label' => __('Text Light', 'website723662'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_background", array(
        'label' => __('Background', 'website723662'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control('font_scheme', array(
        'label' => __('Font Scheme', 'website723662'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_heading', array(
        'label' => __('Heading Font', 'website723662'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_text', array(
        'label' => __('Text Font', 'website723662'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_section('typography', array(
        'capability' => 'edit_theme_options',
        'title' => __('Typography', 'website723662'),
        'priority' => 40,
    ));
    ...
    $wp_customize->add_control('typography_scheme', array(
        'label' => __('Typography Scheme', 'website723662'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'typography_base_size', array(
        'type' => 'number',
        'label' => __('Base Size', 'website723662'),
        'section' => 'typography',
        'input_attrs' => array(
            'min'   => 13,
            'max'   => 24,
    ...
    $wp_customize->add_control('typography_heading_weight', array(
        'label' => __('Heading Weight', 'website723662'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(
            '100' => __('100 Thin', 'website723662'),
            '300' => __('300 Light', 'website723662'),
            '400' => __('400 Regular', 'website723662'),
            '500' => __('500 Medium', 'website723662'),
            '700' => __('700 Bold', 'website723662'),
            '900' => __('900 Black', 'website723662'),
        ),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_width', array(
        'type' => 'number',
        'label' => __('Logo max width (px)', 'website723662'),
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_height', array(
        'type' => 'number',
        'label' => __('Logo max height (px)', 'website723662'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_link', array(
        'type' => 'url',
        'label' => __('Logo link href', 'website723662'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'custom_favicon', array(
        'label' => __('Favicon', 'website723662'),
        'section' => 'title_tagline',
        'priority' => 8,
        'height' => '64',
        'width' => '64',
        'button_labels' => array(
            'select' => __('Select favicon', 'website723662'),
            'change' => __('Change favicon', 'website723662'),
            'remove' => __('Remove', 'website723662'),
            'default' => __('Default', 'website723662'),
            'placeholder' => __('No favicon selected', 'website723662'),
            'frame_title' => __('Select favicon', 'website723662'),
            'frame_button' => __('Choose favicon', 'website723662'),
        ),
    )));
    ...
    $wp_customize->add_section('menu_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Theme options', 'website723662'),
        'panel' => 'nav_menus',
    ));
    ...
    $wp_customize->add_control('menu_trim_title', array(
        ...
        'label' => __('Trim long menu items', 'website723662'),
    ));
    ...
    $wp_customize->add_control('menu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each item to [N] characters', 'website723662'),
    ));
    ...
    $wp_customize->add_control('submenu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each subitem to [N] characters', 'website723662'),
    ));
    ...
    $wp_customize->add_control('menu_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Apply menu item tag filter', 'website723662'),
    ));
    ...
    $wp_customize->add_control('menu_allowed_tags', array(
        'type' => 'text',
        'section' => 'menu_options',
        'label' => __('Allowed menu item tags', 'website723662'),
    ));
    ...
    $wp_customize->add_control('use_default_menu', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Use not stylized menu', 'website723662'),
        'description' => __('Used standart wp_nav_menu when option is enabled (need for some third-party plugins).', 'website723662'),
    ));
    ...
    $wp_customize->add_section('excerpt_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Excerpt', 'website723662'),
    ));
    ...
    $wp_customize->add_control('excerpt_auto', array(
        ...
        'label' => __('Use auto excerpts', 'website723662'),
        'description' => __('Generate post excerpts automatically (When neither more-tag nor post excerpt is used)', 'website723662'),
    ));
    ...
    $wp_customize->add_control('excerpt_words', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt length (words)', 'website723662'),
    ));
    ...
    $wp_customize->add_control('excerpt_min_remainder', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt balance (words)', 'website723662'),
    ));
    ...
    $wp_customize->add_control('excerpt_strip_shortcodes', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Remove shortcodes from excerpt', 'website723662'),
    ));
    ...
    $wp_customize->add_control('excerpt_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Apply excerpt tag filter', 'website723662'),
    ));
    ...
    $wp_customize->add_control('excerpt_allowed_tags', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('Allowed excerpt tags', 'website723662'),
    ));
    ...
    $wp_customize->add_control('show_morelink', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Show More Link', 'website723662'),
    ));
    ...
    $wp_customize->add_control('morelink_template', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('More Link Template', 'website723662'),
        'description' => sprintf(__('ShortTags: %s', 'website723662'), '[url], [text]'),
    ));
    ...
    $wp_customize->add_control('seo_og', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include Open Graph meta tags', 'website723662'),
    ));
    ...
    $wp_customize->add_control('seo_ld', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include schema.org JSON-LD syntax markup', 'website723662'),
    ));
    ...
    $wp_customize->add_section('templates_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Templates', 'website723662'),
        'priority' => 200,
    ));
        ...
        foreach ($templates_parameters as $templateIndex => $template_options) {
                ...
                if (isset($op['options'])) {
                    foreach ($op['options'] as $key => $option) {
                        if (strpos($key, $templateKey . 'Template') === 0) {
                            ...
                            $templatesOptions[$templateKey][$key] = __($option, 'website723662');
                        }
                    }
                }
            }
            if (!in_array($templateKey, $woocommerceTemplateNames) || (in_array($templateKey, $woocommerceTemplateNames) && theme_woocommerce_enabled())) {
                ...
                $wp_customize->add_control( 'theme_template_' . $template . '_' . $templateName . '-template', array(
                    ...
                    'label'       => __( $templateLabel, 'website723662' ),
                    'description' => '',
                ) );
            }
        }
    ...
    $wp_customize->add_section('other_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Other settings', 'website723662'),
        'priority' => 200,
    ));
    ...
    $wp_customize->add_control('include_jquery', array(
        ...
        'label' => __('Use jQuery from theme', 'website723662'),
    ));
    ...
    $wp_customize->add_section('sidebar_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Sidebars', 'website723662'),
        'priority' => 100,
    ));

    $layouts_choices = array(
        '' => __('Default', 'website723662'),
        'left-sidebar' => __('Left', 'website723662'),
        'right-sidebar' => __('Right', 'website723662'),
        'none' => __('None', 'website723662'),
    );
    ...
    $wp_customize->add_control('sidebars_layout_blog', array(
        ...
        'label' => __('Blog Template', 'website723662'),
        'description' => __('Templates for displaying blogs, archives, search results', 'website723662'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_post', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Post Template', 'website723662'),
        'description' => __('Templates for displaying single posts', 'website723662'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_default', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Default Template', 'website723662'),
        'description' => __('Templates for displaying single pages and everything else', 'website723662'),
    ));
}
add_action('customize_register', 'theme_customize_register', 11);

function theme_print_sidebars_blog_caption() {
    printf('<h3>%s</h3>', __('Display sidebars on:', 'website723662'));
}
